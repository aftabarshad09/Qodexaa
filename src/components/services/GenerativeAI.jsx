...
const GenerativeAI = () => {
  ...
  return (
    <div className="ai-page">
      <Helmet>
        <title>AI Analytics Platform Development — Qodexaa</title>
        <meta name="description" content="Turn raw data into business decisions. Qodexaa builds real-time AI analytics dashboards and platforms tailored to your KPIs and growth goals." />
        <meta property="og:title" content="AI Analytics Platform Development — Qodexaa" />
        <meta property="og:description" content="Turn raw data into business decisions. Qodexaa builds real-time AI analytics dashboards and platforms tailored to your KPIs and growth goals." />
