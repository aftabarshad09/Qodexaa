...
const slides = [
  {
    ...
    image: img1,
    label: "ENGINEERING",
    titleLines: ["WE BUILD", "SOFTWARE", "THAT SCALES"],
    subtitle:
      "Custom web & mobile platforms engineered with modern stacks — TypeScript, React, Node and the cloud.",
    cta: "Start a Project",
    path: "/contact",
    accent: "#2563eb",
    accentHover: "#1d4ed8",
    ...
    cardMeta: "PROJECT_01 // PRODUCTION",
  },
  {
    id: 1,
    image: img2,
    label: "PRODUCT TEAMS",
    titleLines: ["DEDICATED", "SQUADS FOR", "YOUR ROADMAP"],
    subtitle:
      "Embed senior engineers, designers and PMs into your team. Ship weekly, iterate faster, scale smarter.",
    cta: "Start a Project",
    path: "/contact",
    accent: "#0f766e",
    accentHover: "#0b5d57",
    bg: "#eaf5f1",
    blobColor: "#bfe2d6",
    tagline: "Team Augmentation",
    stack: ["Agile", "Scrum", "CI/CD", "DevOps"],
    cardMeta: "SQUAD_02 // ACTIVE",
  },
  {
    id: 2,
    image: img3,
    label: "DATA & AI",
    titleLines: ["TURN DATA", "INTO REAL", "DECISIONS"],
    subtitle:
      "Dashboards, pipelines and AI features that integrate with your stack and unlock measurable ROI.",
    cta: "Start a Project",
    ...
    stack: ["Python", "LLMs", "BigQuery", "dbt"],
    cardMeta: "MODEL_03 // INFERENCE",
  },
  {
    id: 3,
    image: img4,
    label: "CLOUD & DEVOPS",
    titleLines: ["RELIABLE", "INFRASTRUCTURE", "BY DEFAULT"],
    subtitle:
      "Kubernetes, IaC and observability done right — 99.99% uptime targets, blue/green deploys, zero drama.",
    cta: "Start a Project",
    path: "/contact",
    accent: "#c2410c",
    accentHover: "#9a3412",
    ...
    stack: ["AWS", "Kubernetes", "Terraform", "Grafana"],
    cardMeta: "CLUSTER_04 // HEALTHY",
  },
];
