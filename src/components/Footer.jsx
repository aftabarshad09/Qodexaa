...
const socials = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/qodexaa/?viewAsMember=true",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/qodexaa/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="15" height="15">
...
export default function Footer() {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      const response = await fetch("https://www.qodexaa.com/api/newsletter/subscribe", {
        method: "POST",
      ...
      <div className="footer__bottom">
        <div className="footer__bottom-inner">
          ...
          <p className="footer__made">
            Made with <span className="footer__heart">Qodexaa</span> in Pakistan
          </p>
        </div>
      </div>
